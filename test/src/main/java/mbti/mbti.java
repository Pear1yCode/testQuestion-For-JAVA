...
public class mbti {
    ...
    public void answer() {
        ...
        if(mbti.equals("CHET")) {
            System.out.println("성향 : 신중 | 두려움 : 사람 | 공포 : 즐김 | 선호 : 공포스릴 => 신중한 ");
            ...
            System.out.println("성향 : 신중 | 두려움 : 사람 | 공포 : 진지 | 선호 : 공포분위기 => 프로파일러형");
        } else if (mbti.equals("CGST")) {
            System.out.println("성향 : 신중 | 두려움 : 귀신 | 공포 : 진지 | 선호 : 공포스릴 => 퇴마형");
        } else if (mbti.equals("CGSM")) {
            System.out.println("성향 : 신중 | 두려움 : 귀신 | 공포 : 진지 | 선호 : 공포분위기");
        } else if (mbti.equals("CGET")) {
            System.out.println("성향 : 신중 | 두려움 : 귀신 | 공포 : 즐김 | 선호 : 공포스릴");
            ...
            System.out.println("성향 : 용감 | 두려움 : 귀신 | 공포 : 진지 | 선호 : 공포스릴 => 퇴마사형");
